...
async function publishAsync(projectRoot, options = {}) {
  ...
  _Logger().default.global.info(`💡 JavaScript bundle sizes effect startup time. ${_chalk().default.dim((0, _TerminalLink().learnMore)(`https://expo.fyi/javascript-bundle-sizes`))}`);
