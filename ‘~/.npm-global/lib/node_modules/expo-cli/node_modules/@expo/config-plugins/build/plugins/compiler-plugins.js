...
const XML_1 = require("../android/XML");
    ...
    return core_plugins_1.withInterceptedMod(config, {
        ...
        async action(_a) {
            ...
            try {
                ...
                WarningAggregator.addWarningAndroid('android-manifest', `AndroidManifest.xml configuration could not be applied. ${error.message}`);
            }
            return results;
        },
    });
    ...
    return core_plugins_1.withInterceptedMod(config, {
        ...
        async action(_a) {
            ...
            try {
                ...
                WarningAggregator.addWarningAndroid(`${modRequest.platform}-${modRequest.modName}`, `strings.xml configuration could not be applied. ${error.message}`);
            }
            return results;
        },
    });
    ...
    return core_plugins_1.withInterceptedMod(config, {
        ...
        async action(_a) {
            ...
            try {
                ...
                WarningAggregator.addWarningAndroid(`${modRequest.platform}-${modRequest.modName}`, `Project build.gradle could not be modified. ${error.message}`);
            }
            return results;
        },
    });
    ...
    return core_plugins_1.withInterceptedMod(config, {
        ...
        async action(_a) {
            ...
            try {
                ...
                WarningAggregator.addWarningAndroid(`${modRequest.platform}-${modRequest.modName}`, `Project settings.gradle could not be modified. ${error.message}`);
            }
            return results;
        },
    });
    ...
    return core_plugins_1.withInterceptedMod(config, {
        ...
        async action(_a) {
            ...
            try {
                ...
                WarningAggregator.addWarningAndroid(`${modRequest.platform}-${modRequest.modName}`, `App build.gradle could not be modified. ${error.message}`);
            }
            return results;
        },
    });
    ...
    return core_plugins_1.withInterceptedMod(config, {
        ...
        async action(_a) {
            ...
            try {
                ...
                WarningAggregator.addWarningAndroid(`${modRequest.platform}-${modRequest.modName}`, `MainActivity could not be modified. ${error.message}`);
            }
            return results;
        },
    });
    ...
    return core_plugins_1.withInterceptedMod(config, {
        ...
        async action(_a) {
            ...
            try {
                ...
                WarningAggregator.addWarningIOS('entitlements', `${entitlementsPath} configuration could not be applied.`);
            }
            return results;
        },
    });
