...
async function register() {
  ...
  if (user === null || user === void 0 ? void 0 : user.accessToken) {
    throw new (_CommandError().default)('ACCESS_TOKEN_ERROR', 'Please remove the EXPO_TOKEN environment var to register as a new user.');
  }
...
`); // Answers from previous questions aren't threaded through with `prompts`, so
  ...
  (0, _log().default)(`\nAccount registered, you are now logged in as ${_chalk().default.cyan(answers.username)}.`);
  (0, _log().default)(`- You can log in to your account on ${_chalk().default.bold('https://expo.io')} to manage and collaborate on your projects.`);
  (0, _log().default)(`- You can log in on the Expo client app for quick access to your projects.\n`);
