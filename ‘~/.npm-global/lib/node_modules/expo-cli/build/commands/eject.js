...
async function actionAsync(projectDir, options) {
  const {
    exp
...
function _default(program) {
  ...
  .option('--no-install', 'Skip installing npm packages and CocoaPods.').option('--npm', 'Use npm to install dependencies. (default when Yarn is not installed)').asyncActionProjectDir(actionAsync);
}
